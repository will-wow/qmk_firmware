...
[_LOWER] = {
  ...
  {_______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______, KC_MINS, KC_EQL,     KC_LBRC,   KC_RBRC,    KC_BSLS},
  {_______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______, S(KC_COMM), S(KC_DOT), S(KC_SLSH), _______},
