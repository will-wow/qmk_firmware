...
#define NAV_SCLN LT(_ADJUST, KC_SCLN)
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Num  | Alt  | GUI  |Lower |    Space    |Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = {
  ...
  {_______,       MO(_NM),KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,    KC_RGHT}
},
